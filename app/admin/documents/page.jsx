...
export default function AdminDocumentHub() {
  return <DocumentHubInterface title="Admin Document Hub" role="admin" />;
}

// Reusable Component Logic
function DocumentHubInterface({ title, role }) {
    ...
    <div className="min-h-screen bg-gray-50 p-8 md:p-12 font-sans text-gray-900">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage company-wide documents.</p>
        </div>
